...
class _Work extends State<Work> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<List<Task>> future = SpeechBloc.cache.fetchTaskList();

    return StreamBuilder(stream: future, builder: (BuildContext context, AsyncSnapshot<List<Task>> snapshot) {
      print('${snapshot.data}');
